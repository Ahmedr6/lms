...
const CourseDetails = () => {
  ...
  const [playerData,setIPlayerData] = useState(null)
  ...
  return courseData ? (
    ...
    justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
      ...
      {/* right col  */}
      <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-non
      overflow-hidden bg-white min-2-[300px] sm:min-w-[420px]'>
        ...
        <div className='p-5'>
          ...
          <div className='flex items-center gap-1'>
            ...
            <p>{calculateRating(courseData)}</p>
                    ...
                    <div className='flex items-center gap-1'>
            <img src={assets.time_clock_icon} alt="colck icon" />
            <p>{calculateCourseDuration(courseData)}</p>
          </div>
          <div className='h-4 w-px bg-gray-500/40'></div>
          <div className='flex items-center gap-1'>
            <img src={assets.lesson_icon} alt="colck icon" />
            <p>{calculateNoOfLectures(courseData)} lessons </p>
          </div>  
         
          </div>
          <button onClick={enrollCourse} className='md:mt-7 mt-4 w-full py-3 rounded bg-blue-600
          ...
          <div className='pt-6'>
           ...
           <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
            ...
            <li>step-by-step, hands-on preoject guidance</li>
