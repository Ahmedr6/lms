...
const AddCourse = () => {
  ...
  const[lectureDeatils,setLectureDetails]=useState(
    {
     lectureTitle:'',
     lectureDuration:'',
     lectureUrl:'',
    ...
    if(action==='add'){
      ...
      if(title){
        const newChapter={
          ...
          chapterContent:[],
          collapsed:false,
          chapterOrder:chapters.length>0? chapters.slice(-1)[0].chapter+
          1:1,
      ...
      setChapters(
        chapters.map((chapter)=>
          chapter.chapterId=== chapterId? {...chapter,collapsed:!chapter.collapsed}
        :  chapter
      )
    )
    }
  ...
  // functionality for adding lectures 
    ...
    justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={ handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500' >
        <div className='flex flex-col gap-1'>
          ...
          md:py-2.5 py-2 px-3 rounded border border-gray-500' required onChange={e=>setCourseTitle(e.target.value) } 
          value={courseTitle} />
        </div>
          <div className='flex flex-col gap-1'>
          ...
          <div>
                ...
                <div className='flex justify-between items-center p-4 border-b'>
                 <div className='flex items-center'>
                  <img onClick={()=>handleChapter('toggle',chapter.chapterId)}
                   className={`mr-2 cursor-pointer transition-all ${chapter.collapsed &&"-rotat-90"}`} src={assets.dropdown_icon} width={14} alt="" />
            ...
            rounded-lg cursor-pointer' onClick={()=>handleChapter('add')}>+Add
             Chapter</div>
              ...
              bg-gray-800 bg-opacity-50'>
                ...
                max-w-80'>
                      ...
                      <div className='mb-2'>
                        ...
                        value={lectureDeatils.lectureTitle}
                        onChange={(e)=> setLectureDetails({...lectureDeatils,
                      ...
                      <div className='mb-2'>
                        ...
                        <input type="number"
                        className='mt-1 block w-full border rounded py-1 px-2'
                        value={lectureDeatils.lectureDuration}
                        onChange={(e)=> setLectureDetails({...lectureDeatils,
                      ...
                      <div className='mb-2'>
                        ...
                        <input type="text"
                        className='mt-1 block w-full border rounded py-1 px-2'
                        value={lectureDeatils.lectureUrl}
                        onChange={(e)=> setLectureDetails({...lectureDeatils,
                        lectureUrl:e.target.value})}
                         />
                            ...
                            <div className='flex gap-2 my-4'>
                              ...
                              checked={lectureDeatils.isPreviewFree}
                              onChange={(e)=>setLectureDetails({...lectureDeatils,
                                isPreviewFree:e.target.checked})} 
                              />
                            </div>

                        <button onClick={addLecture} type='button' className='w-full bg-blue-400 text-white
                        px-4 py-2 rounded'>Add</button>   
