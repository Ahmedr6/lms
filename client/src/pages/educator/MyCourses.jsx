...
const fetchEducatorCourses = async ()=>{
  try {
    ...
    const {data}= await axios.get(backendUrl + '/api/educator/courses', {headers:{ Authorization: `Bearer ${toekn}`}})
...
},[isEducator])  // added here all courses to fetch it everytime when i refresh 

  return courses ? (
    <div className='h-screen flex flex-col items-start justify-between 
    md:p-8 md:pb-0 pt-8 pb-0'>
