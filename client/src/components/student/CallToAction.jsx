  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24
     px-8 md:px-0'>
      ...
      <p className='text-gray-00 xm:text-sm'>incididut sintincididut sintincididut sintincididut sintincididut sintincididut sintincididut sint
      incididut sintincididut sintincididut sint
      incididut sint
      </p>
